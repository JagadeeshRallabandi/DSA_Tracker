...
const planData = [
    ...
    },
    {
        ...
        days: [
            ...
            { day: 29, date: "Aug 30", topic: "Stack & Queues", goal: "Lec 1: Learning (Concepts and Implementation)" },
            { day: 30, date: "Aug 31", topic: "Stack & Queues", goal: "Lec 2: Prefix, Infix, PostFix Conversions" },
            { day: 31, date: "Sep 1", topic: "Stack & Queues", goal: "Lec 3: Monotonic Stack/Queue (First half)" },
            { day: 32, date: "Sep 2", topic: "Stack & Queues", goal: "Lec 3: Monotonic Stack/Queue (Second half)" },
